...
7. Ajoute `OWNER_NUMBERS (facultatif, les commandes sont publiques)` avec le même numéro si tu veux utiliser les commandes de gestion.
8. Déploie.
...
Ces commandes sont protégées par OWNER_NUMBERS (facultatif, les commandes sont publiques).
...
## Sécurité
Les commandes d'ajout/modification/suppression et les commandes cachées de contrôle utilisent `OWNER_NUMBERS (facultatif, les commandes sont publiques)`.
